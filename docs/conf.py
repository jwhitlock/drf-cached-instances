# -*- coding: utf-8 -*-
"""drf-cached-instances build configuration file.
...
project = u'Cached Instances for Django REST Framework'
...
latex_documents = [
    ('index', 'drf-cached-instances.tex',
     u'Cached Instances for Django REST Framework Documentation',
